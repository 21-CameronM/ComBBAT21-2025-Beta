...
public class SUB_Vision extends SubsystemBase {
	...
	public Double getAmbiguity(int id) {
		...
		for (PhotonTrackedTarget tar : io.getTargets(Camera.FORWARD_CAMERA)) {
		...
		for (PhotonTrackedTarget tar : io.getTargets(Camera.REAR_CAMERA)) {
